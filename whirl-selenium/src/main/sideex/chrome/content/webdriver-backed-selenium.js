...
function webdriverBackedSeleniumBuilder() {
  ...
  //get the value stored by 'storeEval' command
  WebdriverBackedSelenium.prototype.doEchoToGetValue = function(message) {
    ...
    if (splits[1] === "ajax") {  
      LOG.sideex.ajax_done = splits[0];  
    } else if (splits[1] === "readyState") {
      LOG.sideex.readyState = splits[0];  
    } 
