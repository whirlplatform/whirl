...
function FormatCollection(options, pluginManager) {
    ...
    this.presetFormats = [
        new InternalFormat(options, "default", "HTML", "html.js", null, true),
        // C#
        new InternalFormat(options, "csharpwdformatter", "C# / NUnit / WebDriver", "csharp/cs-wd.js", "webdriver"),
        new InternalFormat(options, "csharpformatter", "C# / NUnit / Remote Control", "csharp/cs-rc.js", "remotecontrol"),
        // Java
        new InternalFormat(options, "webdriverjunit4formatter", "Java / JUnit 4 / WebDriver", "java/webdriver-junit4.js", "webdriver"),
        new InternalFormat(options, "webdrivertestngformatter", "Java / TestNG / WebDriver", "java/webdriver-testng.js", "webdriver"),
        new InternalFormat(options, "backedjunit4formatter", "Java / JUnit 4 / WebDriver Backed", "java/java-backed-junit4.js", "remotecontrol"),
        new InternalFormat(options, "junit4formatter", "Java / JUnit 4 / Remote Control", "java/java-rc-junit4.js", "remotecontrol"),
        new InternalFormat(options, "junit3formatter", "Java / JUnit 3 / Remote Control", "java/java-rc.js", "remotecontrol"),
        new InternalFormat(options, "testngformatter", "Java / TestNG / Remote Control", "java/java-rc-testng.js", "remotecontrol"),
        // python
        new InternalFormat(options, "pythonwdformatter", "Python 2 / unittest / WebDriver", "python/python2-wd.js", "webdriver"),
        new InternalFormat(options, "pythonformatters", "Python 2 / unittest / Remote Control", "python/python2-rc.js", "remotecontrol"),
        // Ruby
        new InternalFormat(options, "rspecwdformatters", "Ruby / RSpec / WebDriver", "ruby/ruby-wd-rspec.js", "webdriver"),
        new InternalFormat(options, "rubywdformatters", "Ruby / Test::Unit / WebDriver", "ruby/ruby-wd.js", "webdriver"),
        new InternalFormat(options, "rspecformatters", "Ruby / RSpec / Remote Control", "ruby/ruby-rc-rspec.js", "remotecontrol"),
        new InternalFormat(options, "rubyformatter", "Ruby / Test::Unit / Remote Control", "ruby/ruby-rc.js", "remotecontrol")
    ];
    this.reloadFormats();
}
 ...
 */
function InternalFormat(options, id, name, file, type, reversible) {
    this.options = options;
    this.id = id;
    this.name = name;
