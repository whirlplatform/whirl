...
public interface AutoCompletionHandler {
     ...
     * @param caretPosition The caret position, containing line and column information.  Not
     *                      {@code null}.
     * @param caretIndex    The caret index with respect to the editor text.  Not {@code null}.
     * @param callback      A callback that should be used to signal that auto-completion results
     *                      are ready.  Not {@code null}.
     */
    void getCompletions(String text, EditorPosition caretPosition, int caretIndex,
