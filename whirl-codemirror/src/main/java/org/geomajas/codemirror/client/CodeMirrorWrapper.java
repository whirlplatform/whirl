...
public class CodeMirrorWrapper {
	...
	private static native JavaScriptObject fromTextAreaJs(CodeMirrorWrapper wrapper, TextAreaElement tae, JavaScriptObject config) /*-{
	    var options = {
	    			   extraKeys: {
	...
	private static native Object callFunction(JavaScriptObject jso, String name, Object arg1, Object arg2) /*-{
