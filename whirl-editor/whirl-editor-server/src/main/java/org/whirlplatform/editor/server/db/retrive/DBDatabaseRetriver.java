...
public class DBDatabaseRetriver
{
        ...
        throws SQLException
    {
        ...
        // This will avoid the driver problem because CURRENT_TIMESTAMP in the
        ...
        // getEmpireDataType() above is not enough to support AUTOINC as it will
        // only return DataType.INTEGER
