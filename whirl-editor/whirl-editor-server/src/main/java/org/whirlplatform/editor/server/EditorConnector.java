...
public interface EditorConnector {
    ...
    ApplicationElement newApplication(ApplicationBasicInfo appInfo, ApplicationUser user) throws RPCException;
    ...
    ApplicationElement loadApplication(ApplicationStoreData applicationData, ApplicationUser user) throws RPCException;

    void saveApplication(ApplicationElement application, Version version, ApplicationUser user) throws RPCException;
    ...
    ApplicationsDiff diff(ApplicationStoreData left, ApplicationStoreData target) throws RPCException;
