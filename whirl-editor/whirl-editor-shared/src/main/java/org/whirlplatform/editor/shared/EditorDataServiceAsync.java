...
public interface EditorDataServiceAsync {
    ...
    void loadApplication(ApplicationStoreData applicationData, AsyncCallback<ApplicationElement> callback);

    void saveApplication(SaveData saveData, AsyncCallback<SaveResult> callback);

    void saveApplicationAs(SaveData saveData, Version oldVersion, AsyncCallback<SaveResult> callback);

    void syncServerApplication(ApplicationElement application, Version version, AsyncCallback<SaveResult> callback);

    void loadServerApplication(AsyncCallback<SaveResult> callback);

    void newElement(AbstractElement parent, AbstractElement element, AsyncCallback<? extends AbstractElement> callback);

    void getTableImportList(DataSourceElement datasource, SchemaElement schema,
                            AsyncCallback<Collection<RowModelData>> callback);

    void importTables(DataSourceElement datasource, SchemaElement schema, Collection<RowModelData> models,
    ...
    void diff(ApplicationStoreData left, ApplicationStoreData right, AsyncCallback<ApplicationsDiff> callback);
    ...
    void showIconsPanel(AsyncCallback<List<String>> callback);
