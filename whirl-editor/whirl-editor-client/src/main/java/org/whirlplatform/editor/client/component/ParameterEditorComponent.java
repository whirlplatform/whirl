...
public class ParameterEditorComponent extends TriggerField<String> {
    ...
    private HorizontalLayoutData comboLayoutData = new HorizontalLayoutData(150, -1, new Margins(0, 5, 0, 0));
    private HorizontalLayoutData halfLayoutData = new HorizontalLayoutData(0.5, -1, new Margins(0, 5, 0, 0));
    private HorizontalLayoutData fullLayoutData = new HorizontalLayoutData(1, -1, new Margins(0, 5, 0, 0));
    private HorizontalLayoutData buttonLayoutData = new HorizontalLayoutData(30, -1, new Margins(0, 10, 0, 0));

    private class ParameterRow extends HorizontalLayoutContainer {
        LabelProvider<ParameterType> parameterTypeLabelProvider = new LabelProvider<ParameterType>() {
        ...
        public ParameterRow(ComponentStore store, ParameterType propertyType,
            ...
            codeOrIdCombo.add(Arrays.asList(ParameterType.COMPONENTCODE,
                    ParameterType.COMPONENTID, ParameterType.STORAGECODE, ParameterType.STATICVALUE));
            codeOrIdCombo
    ...
    public ParameterEditorComponent(ComponentStore store) {
        ...
        super(new TriggerFieldCell(GWT.<ParameterFieldDefaultAppearance>create(ParameterFieldDefaultAppearance.class)));
    ...
    public void setValue(String value) {
        ...
        if (object.containsKey(ParameterType.STORAGECODE.getJsonName())) {
            JSONArray storage = json.isObject().get(ParameterType.STORAGECODE.getJsonName()).isArray();
        ...
        if (object.containsKey(ParameterType.STATICVALUE.getJsonName())) {
            JSONArray values = json.isObject().get(ParameterType.STATICVALUE.getJsonName()).isArray();
