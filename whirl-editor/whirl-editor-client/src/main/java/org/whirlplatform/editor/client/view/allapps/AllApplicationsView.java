...
public class AllApplicationsView extends Window implements IAllApplicationsView {
    ...
    private static final String OPEN_TITLE = EditorMessage.Util.MESSAGE.open();
    ...
    private void initButtons() {
        ...
        loadButton = new TextButton(OPEN_TITLE, new SelectHandler() {
            @Override
            public void onSelect(SelectEvent event) {
                startApplicationEditing();
            }
        });
        loadButton.setIcon(ComponentBundle.INSTANCE.open());
