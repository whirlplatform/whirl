...
public class ToolbarOpenButton extends AbstractContextTextButton<ToolBarPresenter> {

    public ToolbarOpenButton(final ToolBarPresenter context) {
        super(context);
    }
    ...
    protected SelectHandler createSelectHandler() {
        return new SelectHandler() {
            ...
            public void onSelect(SelectEvent event) {
                getContext().showOpenApplications();
            }
        };
    }
    ...
    protected ImageResource selectButtonIcon() {
        return ComponentBundle.INSTANCE.open();
    }

    @Override
    protected String createToolTip() {
        return EditorMessage.Util.MESSAGE.open();
    }
}
