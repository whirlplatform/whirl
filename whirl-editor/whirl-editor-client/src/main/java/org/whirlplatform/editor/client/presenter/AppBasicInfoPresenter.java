...
public class AppBasicInfoPresenter extends BasePresenter<AppBasicInfoPresenter.IAppBasicInfoView, EditorEventBus> {

	public interface IAppBasicInfoView extends IsWidget, ReverseViewInterface<AppBasicInfoPresenter> {
		void showAsNew();
	...
	public void onGetAppInfoForSaveAs(ApplicationBasicInfo info, Callback<ApplicationBasicInfo, Throwable> callback) {
		loadApplications();
		resultCallback = callback;
