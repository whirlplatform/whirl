...
public class SchemaView extends ContentPanel implements ISchemaView {
	...
	private void initImport() {
		...
		IdentityValueProvider<RowModelData> identityProvider = new IdentityValueProvider<RowModelData>();
		CheckBoxSelectionModel<RowModelData> selectionModel = new CheckBoxSelectionModel<RowModelData>(
				identityProvider);
		selectionModel.setSelectionMode(SelectionMode.MULTI);

		List<ColumnConfig<RowModelData, ?>> columns = new ArrayList<ColumnConfig<RowModelData, ?>>();
		columns.add(selectionModel.getColumn());
		ColumnConfig<RowModelData, String> tableNameColumn = new ColumnConfig<RowModelData, String>(
				new RowModelDataValueProvider<String>("tableName"), 250, EditorMessage.Util.MESSAGE.schema_table());
		...
		ColumnConfig<RowModelData, String> sourceColumn = new ColumnConfig<RowModelData, String>(
				new RowModelDataValueProvider<String>("source"), 250, EditorMessage.Util.MESSAGE.schema_source());
	...
	private void initProcessing() {
		processingMessageBox = new AutoProgressMessageBox(EditorMessage.Util.MESSAGE.schema_processing());
	}
