...
public abstract class ComparableAppTreeWidget extends AbstractAppTree implements ComparableAppTree {
    ...
    @Override
    public void loadApplication(final ApplicationElement app, final Version version,
                                final AppTreePresenter presenter) {
    ...
    protected abstract void showDiff(final List<ChangeUnit> changes,
                                     final Callback<Map<String, Boolean>, Throwable> callback);

    protected void showDiff(final List<ChangeUnit> changes, boolean locked,
                            final Callback<Map<String, Boolean>, Throwable> callback) {
        if (changes == null) {
            return;
        }
