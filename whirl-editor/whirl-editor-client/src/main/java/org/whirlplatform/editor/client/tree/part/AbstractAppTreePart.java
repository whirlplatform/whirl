...
public abstract class AbstractAppTreePart<T extends AbstractElement> implements AppTreePart<T> {
	...
	public AbstractAppTreePart(final AppTree view, final AppTreePresenter treePresenter, final T handlerElement) {
		reference = false;
		this.appTree = view;
	...
	protected void putTreePart(AbstractElement element, AppTreePart<? extends AbstractElement> treePart) {
