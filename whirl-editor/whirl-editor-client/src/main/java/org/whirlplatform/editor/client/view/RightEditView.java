...
//				return null;
	...
	private Table<AbstractElement, GroupElement, Map<RightType, RightChangeComponent>> mappings = HashBasedTable
			.create();
	...
	public Map<AbstractElement, RightCollectionElement> getRights() {
		Map<AbstractElement, RightCollectionElement> result = new HashMap<AbstractElement, RightCollectionElement>();
