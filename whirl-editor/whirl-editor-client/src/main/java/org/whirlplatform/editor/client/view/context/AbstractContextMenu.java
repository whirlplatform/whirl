...
/**
 * Базовая реализация контекстного меню. Предполагается что внутри его будут
 * содержаться Контекстные пункты меню с тем же контекстом. При добавлении
 * пунктов принудительно заменяет у них контекст на свой собственный. При
 * наследовании необходимо реализовать метод initMenu, в котором должны быть
 * созданы и добавлены экземпляры пунктов и разделители. Изменение состояния
