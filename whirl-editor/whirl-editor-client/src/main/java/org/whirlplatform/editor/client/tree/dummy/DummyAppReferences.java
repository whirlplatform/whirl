...
public class DummyAppReferences extends AbstractDummyElement implements OrderedDummy {
    private static final String ID_PREFIX = "dummy-application-references-";
    private static final String TITLE = EditorMessage.Util.MESSAGE.dummy_application_references();
    private static final int INDEX = 60;

    public DummyAppReferences() {
        super();
    }

    public DummyAppReferences(final String id) {
        super(id);
    }
