...
public class TableStore extends ListStore<AbstractTableElement> {
    ...
    private static final Comparator<AbstractTableElement> comparator =
        new Comparator<AbstractTableElement>() {
    ...
    private class TableProxy implements DataProxy<String, List<AbstractTableElement>> {
        ...
        public void load(final String loadConfig,
            ...
            provider.getAvailableTables(
                new Callback<Collection<AbstractTableElement>, Throwable>() {
                    @Override
