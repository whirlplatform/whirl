...
public abstract class AbstractDummyElement extends AbstractElement implements VisitableTreeElement, TreeDummy {
    ...
    /**
     * @param id - id родительского AbstractElement. Уникальность
     *           dummy-элемента обеспечивается добавлением префикса,
    ...
    /**
     * Задает id для dummy используя заданный id родительского AbstractElement и
     * префикса, уникального для каждого класса dummy
     *
