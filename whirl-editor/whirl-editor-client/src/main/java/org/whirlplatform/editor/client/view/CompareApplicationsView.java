...
public class CompareApplicationsView extends Window implements ICompareApplicationsView {
	...
	private final static String COMPARING = EditorMessage.Util.MESSAGE.action_compare_applications();
	...
	private void changeMergeButtonState() {
		if (leftTree.getCheckedSelection().size() > 0 || rightTree.getCheckedSelection().size() > 0) {
