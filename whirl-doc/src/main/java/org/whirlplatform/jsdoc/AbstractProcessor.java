...
/**
 * An abstract annotation processor with some convenience methods and an implicit workflow. The
 * processor uses a {@link CodeGenerator} to generate code / resources from freemarker templates.
 *
 * @author Harald Pehl
 */
...
public abstract class AbstractProcessor extends javax.annotation.processing.AbstractProcessor {
    ...
    protected AbstractProcessor(final Class resourceLoaderClass, final String templates) {
    ...
    /**
     * This method is called after {@link #init(ProcessingEnvironment)} has finished. All protected
     * fields are initialized when this method is called.
     *
    ...
    /**
     * As long as the processing isn't over {@link #onProcess(Set, RoundEnvironment)} will be
     * called, otherwise {@link #onLastRound(RoundEnvironment)} will be called. If there's a
     * {@link ProcessingException} thrown, {@link #onError(ProcessingException)} will be called and
    ...
    /**
     * Called as long as the processing isn't over. The default implementation just returns
     * {@code true}.
     *
     * @param annotations the annotation types requested to be processed
     * @param roundEnv    environment for information about the current and prior round
    ...
    /**
     * Called if the processing is over (last round). The default implementation just returns
     * {@code true}.
     * <p>
     * It's not recommended to use this method to generate java source code. Code generated by this
     * method will not be processed by the compiler! You can generate resource files here or cleanup
     * internal state.
     *
     * @param roundEnv environment for information about the current and prior round
     * @return whether or not the set of annotations are claimed by this processor
    ...
    /**
     * Called when a {@link #onLastRound(RoundEnvironment)} was catched in
     * {@link #process(Set, RoundEnvironment)}. The default implementation logs the exception using
     * {@link #error(ProcessingException)}.
     *
     ...
     */
    protected void code(String template, String packageName, String className,
    ...
    /**
     * Writes the specified source code and wraps any {@code IOException} as
     ...
     */
    protected void writeCode(final String packageName, final String className,
    ...
    /**
     * Writes the specified resource and wraps any {@code IOException} as
     * {@link ProcessingException}.
     *
     * @param packageName  the package name
     * @param resourceName the resource name
     ...
     * @throws ProcessingException if an {@code IOException occurs}
     */
    protected void writeResource(final String packageName, final String resourceName,
    ...
    public void error(Element element, String msg, Object... args) {
        messager.printMessage(ERROR, String.format(msg, args), element);
    }
