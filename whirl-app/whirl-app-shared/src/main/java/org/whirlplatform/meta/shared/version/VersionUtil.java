...
public class VersionUtil {
     ...
     *
     * @param value - the string representation of the version
     ...
     *
     * @param version - given version of the application
     ...
     *
     * @param parent  - the parent url to the application
     * @param version - given version of the application
     * @return url
     */
     ...
     *
     * @param version1 - первый Version объект
     * @param version2 - второй Version объект
