...
public class BoxLayoutDataOverlay {
     ...
     * @param flex         коэффициент ширины компонента, вычисляемый пропорционально значений flex
     *                     соседних компонентов. например, если flex компонента = 2 и сумма flex
     *                     других соседних компонентов = 8, то компонент будет занимать 20% ширины
     *                     контейнера. или, flex1 = 1, flex2 = 2, flex3 = 3 - то компонент с flex =
     *                     1 будет занимать 1/6 ширины контейнера.
     ...
     */
    public static BoxLayoutData constructor(int minSize, int maxSize,
                                            double flex, int marginTop, int marginRight,
                                            int marginBottom,
                                            int marginLeft) {
