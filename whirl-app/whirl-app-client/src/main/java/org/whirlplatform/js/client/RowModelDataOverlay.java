...
/**
 * Хранит информацию о данных, хранящихся в строках грида. Позволяет получить идентификатор строки,
 * а также значение, находящееся в определённом столбце этой строки.
 */
public abstract class RowModelDataOverlay {
    ...
    /**
     * Получить значение {@link DataValueOverlay DataValue} из заданной строки(RowModelData) и имени
     * столбца (String property)
     *
     * @param property
     * @return
     */
