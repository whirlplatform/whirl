...
public class FilterPanel extends VerticalLayoutContainer
    ...
    private class FilterSet implements LocatorAware {
        ...
        private Locator createFilterLocator(Widget widget, Element element, boolean isChild,
                                            boolean isCombo) {
        ...
        /**
         * Проверяет есть ли в панели фильтрации комбо - боксы и является ли элемент частью одного
         * из них.
         *
         * @param element
         * @return
