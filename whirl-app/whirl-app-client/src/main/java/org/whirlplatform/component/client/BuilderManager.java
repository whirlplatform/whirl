...
public class BuilderManager {
	...
	public static ComponentBuilder getParentComponent(ComponentBuilder builder, ComponentType type) {
		return getParentComponent(getRoot(), builder, type);
	}
	
	private static ComponentBuilder getParentComponent(Containable container, ComponentBuilder builder, ComponentType type) {
