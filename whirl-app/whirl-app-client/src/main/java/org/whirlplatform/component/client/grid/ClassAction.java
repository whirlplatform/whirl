...
public class ClassAction implements HasHandlers, LoadEvent.HasLoadHandlers,
        InsertEvent.HasInsertHandlers, UpdateEvent.HasUpdateHandlers, DeleteEvent.HasDeleteHandlers {
	...
	public ClassAction(ClassMetadata metadata,
			ClassStore<RowModelData, ClassLoadConfig> store, ParameterHelper paramHelper) {
	...
	/**
	 * Если указан стор, то подвязываем к нему слушателей на insert, update,
	 * delete.
	 */
