...
public class JavaScriptContext {
    ...
    /**
     * Получить список параметров следующего события
     *
    ...
    /**
     * Вернуть параметр следующего события по порядковому номеру. Нумерация начинается с 0.
     *
    ...
    /**
     * Вернуть параметр следующего события с заданным кодом
     *
     * @param code  - код
