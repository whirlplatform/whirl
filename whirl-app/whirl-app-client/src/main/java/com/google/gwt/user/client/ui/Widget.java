 ...
 * events from the browser and being added directly to
...
public class Widget extends UIObject implements EventListener, HasAttachHandlers,
     ...
     * the sinking of events to improve startup performance.) When the widget is attached, this is
     * set to -1
     * <p>
     ...
     * contains a widget should ever set this value. It serves as a place to store layout
     * bookkeeping data associated with a widget.
     *
    ...
    /**
     * Determines whether this widget is currently attached to the browser's document (i.e., there
     * is an unbroken chain of widgets between this widget and the underlying browser document).
     *
     ...
     * added to the detach list via {@link RootPanel#detachOnWindowClose(Widget)}), it will be
     * removed from the detached immediately. This makes it possible for Composites and Panels to
     * adopt root widgets.
     * </p>
     *
    ...
    /**
     * Creates the {@link HandlerManager} used by this Widget. You can override this method to
     * create a custom {@link HandlerManager}.
     *
    ...
    /**
     * Fires an event on a child widget. Used to delegate the handling of an event from one widget
     * to another.
     *
     ...
     * notification after a Widget has been added to the document, override the {@link #onLoad}
     * method or use {@link #addAttachHandler}.
     * </p>
     * <p>
     * It is strongly recommended that you override {@link #onLoad()} or {@link #doAttachChildren()}
     * instead of this method to avoid inconsistencies between logical and physical attachment
     * states.
     * </p>
     * <p>
     ...
     * {@link #doDetachChildren()} instead of this method to avoid inconsistencies between logical
     * and physical attachment states.
     * </p>
     * <p>
     * Subclasses that override this method must call
     * <code>super.onDetach()</code> to ensure that the Widget has been detached
     * from the underlying Element. Failure to do so will result in application memory leaks due to
    ...
    /**
     * This method is called immediately before a widget will be detached from the browser's
     * document.
     */
