...
/**
 * Для автоматического преобразования исключений {@link CustomException} в корректный json ответ
 * клиенту.<br/> На клиент отправляется сериализованный {@link ExceptionData} из исключения.<br/>
