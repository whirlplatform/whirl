...
public class MainInitializerServlet extends QuartzInitializerServlet {
    ...
    public void init(ServletConfig ctx) throws ServletException {
        ...
        JobDetail sessionJob = JobBuilder.newJob(SessionKillerJob.class).withIdentity("SessionJob").build();
        ...
        StdSchedulerFactory factory = (StdSchedulerFactory) ctx.getServletContext().getAttribute(QUARTZ_FACTORY_KEY);
        try {
