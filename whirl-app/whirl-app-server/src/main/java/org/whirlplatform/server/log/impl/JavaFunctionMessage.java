...
public class JavaFunctionMessage extends AbstractMessage {
	...
	public JavaFunctionMessage(ApplicationUser user, EventMetadata event, Collection<DataValue> params) {
		super(user);
		this.event = event;
		this.params = params;
	}
	...
	public String getMessage() {
		...
		builder.append("{\"type\": \"javaFunction\", \"code\": \"").append(event.getCode()).append("\", ");
